...
from models.se_resnext import *#SE_ResNeXt101_32x4d
random.seed(42)
np.random.seed(42)
import sys
...
batch_size = 32
EPOCH_NUM=20
params_dirname = "./checkpoint0105"
pretrained_model_path = './SE_ResNeXt101_32x4d_pretrained/'
finetune_exclude_pretrained_params = ['fc6_offset','fc6_weights']
...
# main train loop.
    def train_loop():
        ...
        # 查看 var 参数是不是在预训练模型路径内
            if var.name in finetune_exclude_pretrained_params:
                return 0
            else:
